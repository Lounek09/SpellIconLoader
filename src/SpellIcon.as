...
class SpellIcon 
{
	...
	{
		var spellBackground = getSWFChildByName(this._mcBack, "_spellBackground");
		if(spellBackground != null)
		{
			var color = new Color(spellBackground);
			color.setRGB(backgroundColor);
		}
		
		var spellFrame = getSWFChildByName(this._mcBack, "_spellFrame");
		if(spellFrame != null)
		{
			var color = new Color(spellFrame);
	...
	{
		var spellPrint = getSWFChildByName(this._mcUp, "_spellPrint");
		if(spellPrint != null)
		{
			var color = new Color(spellPrint);
